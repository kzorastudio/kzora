...
export default function AdminLayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-surface w-full max-w-full overflow-x-hidden" dir="rtl" lang="ar">
      <AdminSidebar open={sidebarOpen} onClose={() => setSidebarOpen(false)} />

      <main className="flex-1 lg:mr-[230px] bg-surface min-h-screen w-full max-w-full overflow-x-hidden">
        {/* Mobile top bar */}
